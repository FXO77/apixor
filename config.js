...
shuffle(audio_list);
const audio = "https://api.dannteam.com/audio/" + audio_list[0] + ".mp3";
function shuffle(_0x3ae710) {
  for (let _0x2ade7b = _0x3ae710.length - 1; _0x2ade7b > 0; _0x2ade7b--) {
    const _0x48e856 = Math.floor(Math.random() * (_0x2ade7b + 1));
